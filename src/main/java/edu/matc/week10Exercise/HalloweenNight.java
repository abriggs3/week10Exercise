    ...
    public void add(CandyBeggar candyBeggar) {
        ...
        synchronized (listOfCandyBeggars) {
            if (listOfCandyBeggars.size() == placeInLine) {
                System.out.println("No chair available for customer " + candyBeggar.getName());
                System.out.println("Customer " + candyBeggar.getName() + "Exists...");
                return;
            }

            ((LinkedList<CandyBeggar>) listOfCandyBeggars).offer(candyBeggar);
            System.out.println("Customer : " + candyBeggar.getName() + " got the chair.");
